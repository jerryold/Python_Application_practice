...
for f1 in listdir(folder):
    ...
    for f2 in listdir(folder+f1):     
        ...
        for f3 in listdir(folder+f1+"/"+f2):
            ...
            if folder+f1 == "./dataset_test/test_26":
              
                if folder+f1+"/"+f2=="./dataset_test/test_26/AEVRQ":                       
                ...
                elif folder+f1+"/"+f2=="./dataset_test/test_26/ATA_SECURITY":                       
                ...
                elif folder+f1+"/"+f2=="./dataset_test/test_26/HOST_CONTROLLED_THERMAL_MANAGEMENT":                       
                ...
                elif folder+f1+"/"+f2=="./dataset_test/test_26/PCIE_REGISTER":                       
                ...
                elif folder+f1+"/"+f2=="./dataset_test/test_26/LOW_POWER_MODE":                       
                ...
                elif folder+f1+"/"+f2=="./dataset_test/test_26/RESERVATION":                       
                ...
                elif folder+f1+"/"+f2=="./dataset_test/test_26/SET_FEATURES":                       
...
with open('test_all(category).csv', 'w',newline='', encoding="utf8", errors='ignore') as f:
